...
parser.add_argument('--embed_size', type=int, default=128, help='embedding size of d')
...
parser.add_argument('--use_bias', action='store_true', default=False, help='use bias')
parser.add_argument('--weight_decay', type=float, default=0.0001, help='weight decay')
parser.add_argument('--use_comKAN', type=int, default=1, help='1: without comKAN 0: use comKAN')
