...
def main():
    ...
    for pred_len in pred_lens:
        ...
        study = optuna.create_study(
            ...
            study_name=f'AllD_ETTh1_{pred_len}',  # 每个pred_len单独的优化任务
            storage=f'sqlite:///optunaDB/AllD_ETTh1_{pred_len}.db',  # 每个预测长度使用不同的数据库
            load_if_exists=True
        )
